...
use BWC\Component\JwtApi\Receiver\ReceiverInterface;
use BWC\Component\JwtApi\Sender\SenderInterface;
...
//    {
//        $jwt = $this->jwtEncoder->decode($jwtString, '\BWC\Component\JwtApi\Method\MethodJwt');
//
//        return $jwt;
//    }
//
