...
use BWC\Component\JwtApiBundle\Context\JwtContextManager;
...
class JwtContextManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\BWC\Component\JwtApiBundle\Context\Bearer\BearerProviderInterface
     */
    protected function getBearerProviderMock()
    {
        return $this->getMock('BWC\Component\JwtApiBundle\Context\Bearer\BearerProviderInterface');
    }
